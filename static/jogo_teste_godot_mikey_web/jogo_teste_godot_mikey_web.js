...
const Features = { // eslint-disable-line no-unused-vars
	 ...
	 * This value is dependent on Cross-OSharedArrayBuffer rigin-Opener-Policy and Cross-Origin-Embedder-Policy headers sent by the server.
	...
	isCrossOriginIsolated: function () {
		return true;//window['crossOriginIsolated'] === true;
	},
	...
	isSharedArrayBufferAvailable: function () {
		return true;//'SharedArrayBuffer' in window;
	},
